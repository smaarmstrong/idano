...
class Project(models.Model):
    ...
    company = models.CharField(max_length=255, blank=True, null=True)  # Optional company field
    tech_stack = models.TextField(blank=True, null=True)  # Optional tech stack field
    website = models.URLField(blank=True, null=True)  # Optional link field for external website
